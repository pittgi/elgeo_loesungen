...
Sei $D$ der Lotfuss von $A$ auf die Gerade $CB$.
...
\end{align*}
Sei nun $h=|CE|$ die Höhe auf der Seite $c$ mit $E$ als Lotfu\ss \space von $C$ zu $c$. Dann kann $h$ im Dreieck $ACE$ und $BCE$ berechnet werden. Also gilt:
